...
1. Select **New registration**. On the **App registrations** page, set the values as follows.
    ...
    - Under **Redirect URI**, set the first drop-down to `Single-page application (SPA)` and set the value to `https://officedev.github.io/Excel-Scenario-based-Add-in-Samples/Mail-Merge-Sample-Add-in/src/taskpane/consent.html`.
